...
import {mScale} from '../../configs/size';
...
export default class VideoPlayer extends Component {
  ...
  renderVolume() {
    return (
      <View style={{...styles.volume.container, width: this.props.volumeWidth}}>
        <View
      ...
      <TouchableWithoutFeedback
        ...
        <View style={[styles.player.container, this.styles.containerStyle]}>
          <Video
            ...
            onFullscreenPlayerDidDismiss={this.onFullScreenToggle}
            onEnterFullscreen={this.onFullScreenToggle}
            onExitFullscreen={this.onFullScreenToggle}
          />
          {this.renderError()}
          {this.renderLoader()}
